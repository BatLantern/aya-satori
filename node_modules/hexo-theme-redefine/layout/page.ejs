...
<main class="page-container" id="swup">
    ...
    <% var isHome = is_home(); %>
    <% if (theme.home_banner.enable === true && isHome && !page.prev) { %>
        <%- partial('_partials/home-banner') %>
    <% } else if (theme.home_banner.enable === true && isHome && page.prev && theme.home_banner.style === "fixed") { %>
        <%- partial('_partials/home-banner') %>
        <%#- partial('_partials/home-background') %>
    <% } %>
    ...
    <div class="main-content-container">
        ...
        <% if (isHome) { %>
            <div class="main-content-body" style="background-image: none;">
        <% } else { %>
            <div class="main-content-body">
        <% } %>

            <% if (isHome && theme.home.sidebar.enable === true && theme.home.sidebar.position === "left") { %>
                <%- partial('_partials/home-sidebar') %>
            <% } %>
            ...
            <div class="main-content">
                ...
                <% } else if (page.title === 'category' || page.title === 'categories' || page.type === "categories" || page.type === "category") { %>
                    <%- partial('category-list') %>

                <% } else if (page.title === 'tag' || page.title === 'tags' || page.type === "tags" || page.type === "tag") { %>
    ...
    <% if (theme.navbar.search.enable) { %>
        <%- partial('_widgets/local-search') %>
    <% } %>

</main>

<% if (theme.global.single_page !== false) { %>
    <%- partial('_plugins/swup') %>
<% } %>
