...
<div class="home-banner-container flex justify-center items-center transition-fade relative">
    ...
    <div class="content mt-8 flex flex-col justify-center items-center">
        ...
        <div class="banner-titles">
            <% const titles = theme.home_banner.title_parts.filter(Boolean);
               const displayTitles = titles.length ? titles : ['Theme Redefine']; %>
            <div class="banner-title">
                <% displayTitles.forEach((title, index) => { %>
                    <span class="title-part title-part-<%= index + 1 %>"><%= title %></span>
                <% }); %>
            </div>
        </div>
