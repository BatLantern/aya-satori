    ...
    <div class="content mt-8 flex flex-col justify-center items-center">
        ...
        >
            <div class="banner-titles">
                <div class="banner-titlea"><%- theme.home_banner.title_parts.titlea || theme.style.first_screen.description || config.description %></div>
                <%# theme.home_banner.title || theme.style.first_screen.description || config.description %>
                <div class="banner-titleb"><%- theme.home_banner.title_parts.titleb || theme.style.first_screen.description || config.description %></div>
                <div class="banner-titlec"><%- theme.home_banner.title_parts.titlec || theme.style.first_screen.description || config.description %></div>
            </div>
