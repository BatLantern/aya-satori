...
<div class="home-banner-container flex justify-center items-center transition-fade relative">
    ...
    <div class="content mt-8 flex flex-col justify-center items-center">
        ...
        <% if (theme.home_banner.custom_font.enable) { %>
             style="font-family: '<%- theme.home_banner.custom_font.family %>'; !important;"
                <% } %>
        >
            <div class="banner-titles">
                <div class="banner-title"><%- theme.home_banner.title || theme.style.first_screen.description || config.description %></div>
                <%# theme.home_banner.title || theme.style.first_screen.description || config.description %>
                <div class="banner-titleb"><%- theme.home_banner.titleb %></div>
                <div class="banner-titlec"><%- theme.home_banner.titlec %></div>
            </div>
    ...
    <script type="text/javascript" src="/js/tools/scrollToMain.js"></script>
</div>