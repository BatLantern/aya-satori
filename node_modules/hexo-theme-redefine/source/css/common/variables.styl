...
//                                       BANNER & LABEL COLORS
// ========================================================================================
$temp-banner-title-color-a = convert(hexo-config('home_banner.title_colors.title_color_a'))
$banner-title-color-A = $temp-banner-title-color-a ? $temp-banner-title-color-a : var(--home-banner-text-color)
$temp-banner-title-color-b = convert(hexo-config('home_banner.title_colors.title_color_b'))
$banner-title-color-B = $temp-banner-title-color-b ? $temp-banner-title-color-b : var(--home-banner-text-color)
$temp-banner-title-color-c = convert(hexo-config('home_banner.title_colors.title_color_c'))
$banner-title-color-C = $temp-banner-title-color-c ? $temp-banner-title-color-c : var(--home-banner-text-color)