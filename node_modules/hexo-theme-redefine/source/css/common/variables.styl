...
$temp-global-opacity = hexo-config('articles.post_opacity.global_opacity')
$global-opacity = $temp-global-opacity ? $temp-global-opacity : 1.0
$temp-toc-opacity = hexo-config('articles.post_opacity.toc_opacity')
$toc-opacity = $temp-toc-opacity ? $temp-toc-opacity : 1.0
...
//                                       BANNER & LABEL COLORS
// ========================================================================================
convert-color(config-key, default-value)
  temp-color = hexo-config(config-key)
  temp-color ? convert(temp-color) : default-value
$banner-title-color-A = convert-color('home_banner.title_colors[0]', var(--home-banner-text-color))
$banner-title-color-B = convert-color('home_banner.title_colors[1]', var(--home-banner-text-color))
$banner-title-color-C = convert-color('home_banner.title_colors[2]', var(--home-banner-text-color))
$label-custom-color-a = convert-color('articles.author_label.custom_color[0]', var(--third-text-color))
$label-custom-color-b = convert-color('articles.author_label.custom_color[1]', var(--third-text-color))